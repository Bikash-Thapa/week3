...
const encrypt = async (
  ...
  // As multihash returns an array, it is needed to covert it into bigint type
  // The conversion is done using buf2Bigint() funtion
  const iv = buf2Bigint(mimc7.multiHash(plaintext, BigInt(0)));

  // determined ciphertext from sharedkey and iv
...
const decrypt = async (
  ...
  // extracting plaintext from cipherText
